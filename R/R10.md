...
Call:
lm(formula = 제품_만족도 ~ 제품_적절성 + 제품_친밀도, data = product)
...
> cor(product$제품_친밀도+product$제품_적절성, product$제품_만족도)
[1] 0.7017394

# 예측치와 실제 관측치는 상관계수가 0.7017394 이므로 높은 상관관계를 보인다고 할 수 있으며, 
...
> price <- lm(formula= price ~ carat+cut+ depth + table, data=diamonds)
> price
...
Coefficients:
(Intercept)        carat        cut.L        cut.Q  
    4296.95      7890.77      1028.09      -483.30  
      cut.C        cut^4        depth        table  
     325.17        59.23       -73.69       -41.82 
